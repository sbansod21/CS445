...
// T IS PLACEHOLDER FOR ACTUAL TYPE TAHT WILL BE PASSED IN FROM MAIN OR CLIENT
class ArrBag<T>
{
    ...
    public boolean contains( T key )
    {
        ...
        if ( theArray[i].equals( key ) ) return true;
        // WE ARE MAKING AN ASSUMPTION ABOUT TYPE T... WHAT IS IT?
